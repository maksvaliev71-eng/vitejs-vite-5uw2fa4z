  ...
  sections: [
    {
      ...
      items: [
        ...
        "1.5. Обезличенная статистика посещений собирается сервисом Яндекс.Метрика: страницы, которые открывались, источник перехода, тип устройства и браузера, приблизительный регион. Эти данные не позволяют определить личность и используются только для оценки посещаемости.",
      ],
    },
    {
    ...
    },
    {
      ...
      items: [
        ...
        "4.2. Обезличенные данные о посещениях обрабатываются сервисом Яндекс.Метрика в соответствии с его собственной политикой. Отказаться от сбора можно, отключив сбор данных в настройках браузера или установив блокировщик.",
      ],
    },
    {
